...
class Ui_MainWindow(object):
    ...
    def openWindow_clinician(self):
        """!
        @brief Function to show the clinician screen.
        """
    ...
    def openWindow_user(self):
        """!
        @brief Function to show the user screen.
        """
        self.window=QtWidgets.QMainWindow()
    ...
    def setupUi(self, MainWindow):
        ...
        self.label_2.setStyleSheet("background-color:transparent; color:rgb(255, 223, 62); ")
        ...
        self.label_3.setStyleSheet("background-color:transparent; color:rgb(255, 255, 255);")
        ...
        self.pushButton.setStyleSheet("background-color: rgb(255, 223, 62); border-radius:20px; color:rgba(9, 66, 254, 255);")
        ...
        self.pushButton_2.setStyleSheet("background-color: rgb(255, 223, 62); border-radius:20px; color:rgba(9, 66, 254, 255);")
